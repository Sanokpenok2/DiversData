...
require 'divers_bot/messenger/incoming_message'
require 'divers_bot/services/messages'
require 'divers_bot/services/report_summary'
require 'divers_bot/services/photo_storage'
