...
Проект сбора данных об устрицах: бот MAX для дайверов и веб-портал для учёных.

## Компоненты

| Папка | Описание |
|-------|----------|
| `DiversBot/` | Чат-бот MAX — сбор отчётов от дайверов в PostgreSQL |
| `DiversWebSite/` | Rails-сайт для учёных — карта, фильтры, избранное |
| `docs/` | Мини-приложение карты (GitHub Pages) |
